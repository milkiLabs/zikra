...
define(['./workbox-1b3d9405'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    "url": "registerSW.js",
    "revision": "5de8ed90c88dec0ce493e11aa4c15ecb"
  }, {
    "url": "index.html",
    "revision": "0.qqubk0una8g"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/^https:\/\/api\.allorigins\.win\/.*/i, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/^https:\/\/noembed\.com\/.*/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^https:\/\/openlibrary\.org\/.*/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^https:\/\/api\.crossref\.org\/.*/i, new workbox.CacheFirst({
