 ...
 * Icon Components
 * 
 * SVG icons as SolidJS components
 */
...
const createIcon = (paths: string, viewBox = '0 0 24 24'): Component<IconProps> => {
  return (props) => {
...
export const HeartFilledIcon: Component<IconProps> = (props) => {
  const size = () => props.size || 24;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
